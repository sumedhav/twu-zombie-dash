...
<head>
    <title>Zombie Dash : Conference Tasks</title>
             ...
             <h1 class="pageTitle">
          	...
          	<div class="row-fluid">
                  <table class="table table-bordered">
                    ...
                    <div>
                    <a href="${pageContext.request.contextPath}/zombie/gamedesigner/home" name="back_conference_view" id="back_conference_view" class="btn btn-primary offset12">Back</a>
                    </div>
                    <div>
