             ...
             <div class="taskList">
          	...
          	<div class="row-fluid">
                  <table class="table table-bordered">
                    ...
                    <br />
                    <br />
                    <a href="${pageContext.request.contextPath}/zombie/gamedesigner/home" name="back_conference_view" id="back_conference_view" class="btn btn-primary offset10">Back</a>
                    </div>
