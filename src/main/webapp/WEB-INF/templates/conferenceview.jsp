             ...
             <h1 class="pageTitle">
          	...
          	<div class="row-fluid">
                  <table class="table table-bordered">
                    ...
                    <div>
                    <a href="${pageContext.request.contextPath}/zombie/admin/conference/list" name="back_conference_view" id="back_conference_view" class="btn btn-primary offset11">Back</a>
                    </div>
