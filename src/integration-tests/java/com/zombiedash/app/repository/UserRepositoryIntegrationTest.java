...
public class UserRepositoryIntegrationTest {
    ...
    public void shouldHashUserPassword() throws Exception {
        ...
        assertThat(result , is(sha512Hex("password1")));
    }

    @Test
    public void shouldLookUpAuthenticationCredentialsAndReturnUsernameIfFound() throws Exception {
        jdbcTemplate.execute("INSERT INTO zombie_users VALUES('beta123', '" + sha512Hex("password1") + "', 1, 'Game Designer 1', 'gm1@zombie.com')");
